            ...
            <div class="top-area">
                <div class="header-area">
                    ...
                    <div class="wrap-sticky" style="height: 66px;">
                        <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy on no-full sticked"
                ...
                <div class="new-cars-content">
                    <div class="owl-carousel owl-theme owl-loaded owl-drag" id="new-cars-carousel">
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(-2160px, 0px, 0px); transition: all; width: 5040px;">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="owl-carousel testimonial-carousel owl-loaded owl-drag">
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(-1125px, 0px, 0px); transition: 1s; width: 2625px;">
            ...
            <div class="container">
                <div class="brand-area">
                    <div class="owl-carousel owl-theme brand-item owl-loaded owl-drag">
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(-960px, 0px, 0px); transition: 1s; width: 2880px;">
